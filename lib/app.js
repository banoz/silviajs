...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsLoginJsx = __webpack_require__(192);
	  ...
	  _createClass(App, [{
	    ...
	    value: function renderPage() {
	      switch (this.props.page) {
	        ...
	        case "login":
	          return _react2["default"].createElement(_componentsLoginJsx2["default"], null);
	      }
	    }
	  }]);
	...
	var Login = (function (_Component) {
	  ...
	  _createClass(Login, [{
	    ...
	    value: function doLogin() {
	      (0, _redux.dispatch)((0, _actions.loginToParticle)(this.state.email, this.state.password));
	    }
	  }, {
	    key: "handleChange",
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "form",
	            { className: "login-form", onSubmit: this.doLogin },
	            _react2["default"].createElement("input", { type: "email", className: "form-control", name: "email", placeholder: "Particle.io email",
	              value: this.state.email, onChange: this.handleChange }),
	            _react2["default"].createElement("input", { type: "password", className: "form-control", name: "password", placeholder: "Particle.io password",
	              value: this.state.password, onChange: this.handleChange }),
	            _react2["default"].createElement("input", { type: "submit", value: "Log in", className: "btn btn-warning btn-block" })
	          )
	        )
	      );
	    }
