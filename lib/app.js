...
/***/ function(module, exports, __webpack_require__) {
	...
	function calibrations(state, action) {
	  if (state === undefined) state = defaultCals;
	
	  switch (action.type) {
	    case _actions.CALS_FETCH:
	      return Object.assign({}, state, {
	        state: _defineProperty({}, action.group, "fetching")
	      });
	    case _actions.CALS_FAILURE:
	      return Object.assign({}, state, {
	        state: _defineProperty({}, action.group, "not loaded")
	      });
	    case _actions.CALS_RECEIVE:
	      return Object.assign({}, state, {
	        state: _defineProperty({}, action.group, "loaded"),
	...
	function fetchWakeupTime() {
	  return function (dispatch) {
	    ...
	    _libSpark2["default"].callFunction(deviceName, "get", deviceWakeupTime).then(function () {
	      return _libSpark2["default"].getVariable(deviceWakeupTime, "result");
	    }).then(function (payload) {
	      var wakeupTime = JSON.parse(payload);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sleep = (function (_Component) {
	  ...
	  _createClass(Sleep, [{
	    ...
	    value: function render() {
	      var loaded = this.props.loaded;
	      var wakeTime = loaded ? this.timeFromTimestamp(this.props.wakeTime) : "–";
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              "td",
	              null,
	              _react2["default"].createElement(_CalValueJsx2["default"], { value: wakeTime,
	                onChange: this.onChange("wakeTime") })
	            )
	          ),
	          _react2["default"].createElement(
	            "h2",
	...
	Sleep.propTypes = {
	  onMount: _react.PropTypes.func.isRequired,
	  loaded: _react.PropTypes.bool.isRequired,
	  wakeTime: _react.PropTypes.number
	};
