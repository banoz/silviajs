...
/******/ 	__webpack_require__.p = "/home/monkbroc/Programming/silviajs/public";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersRootJsx = __webpack_require__(157);
	
	var _containersRootJsx2 = _interopRequireDefault(_containersRootJsx);
	
	window.onload = function () {
	  _react2["default"].render(_react2["default"].createElement(_containersRootJsx2["default"], null), document.querySelector("#root"));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppJsx = __webpack_require__(184);
	  ...
	  _createClass(Root, [{
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        { store: store },
	        function () {
	          return _react2["default"].createElement(_AppJsx2["default"], null);
	        }
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PersistentState = __webpack_require__(180);
	
	var _PersistentState2 = _interopRequireDefault(_PersistentState);
	
	var _actions = __webpack_require__(181);
	
	var defaultPage = "status";
	
	function page(state, action) {
	  if (state === undefined) state = defaultPage;
	...
	var defaultLogin = {
	  inProgress: false,
	  failed: false,
	  token: _PersistentState2["default"].loadToken()
	};
	
	function login(state, action) {
	  if (state === undefined) state = defaultLogin;
	...
	function variables(state, action) {
	  if (state === undefined) state = defaultVariables;
	
	  switch (action.type) {
	    case _actions.DATA_STREAM:
	      return Object.assign({}, state, {
	        request: action.request
	      });
	    case _actions.DATA_RECEIVE:
	      return Object.assign({}, state, {
	        data: action.data
	      });
	    default:
	...
	var defaultCalsState = {
	  mainCals: "not loaded",
	  sleepCals: "not loaded"
	};
	
	function calibrationState(state, action) {
	  if (state === undefined) state = defaultCalsState;
	
	  var _loadingState;
	
	  switch (action.type) {
	    case _actions.CALS_FETCH:
	    case _actions.CALS_FAILURE:
	    case _actions.CALS_RECEIVE:
	      var loadingState = (_loadingState = {}, _defineProperty(_loadingState, _actions.CALS_FETCH, "fetching"), _defineProperty(_loadingState, _actions.CALS_FAILURE, "not loaded"), _defineProperty(_loadingState, _actions.CALS_RECEIVE, "loaded"), _loadingState);
	
	      return Object.assign({}, state, _defineProperty({}, action.group, loadingState[action.type]));
	    default:
	      return state;
	  }
	}
	...
	function calibrationsData(state, action) {
	  if (state === undefined) state = defaultCalsData;
	
	  switch (action.type) {
	    case _actions.CALS_SET:
	...
	var calibrations = (0, _redux.combineReducers)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loginToParticle = loginToParticle;
	exports.loginWithToken = loginWithToken;
	exports.dataStream = dataStream;
	exports.dataReceive = dataReceive;
	exports.subscribeToDeviceData = subscribeToDeviceData;
	exports.calsFetch = calsFetch;
	exports.calsReceive = calsReceive;
	exports.calsSet = calsSet;
	exports.calsFailure = calsFailure;
	exports.fetchCalibrations = fetchCalibrations;
	exports.fetchWakeupTime = fetchWakeupTime;
	exports.setCalibration = setCalibration;
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
	
	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
	
	var _libSpark = __webpack_require__(182);
	
	var _libSpark2 = _interopRequireDefault(_libSpark);
	
	var _libFirmwareDataMapper = __webpack_require__(183);
	
	var _libFirmwareDataMapper2 = _interopRequireDefault(_libFirmwareDataMapper);
	...
	var DATA_STREAM = "data_stream";
	exports.DATA_STREAM = DATA_STREAM;
	var DATA_RECEIVE = "data_receive";
	
	exports.DATA_RECEIVE = DATA_RECEIVE;
	var CALS_FETCH = "cals_fetch";
	exports.CALS_FETCH = CALS_FETCH;
	var CALS_RECEIVE = "cals_receive";
	exports.CALS_RECEIVE = CALS_RECEIVE;
	var CALS_SET = "cals_set";
	exports.CALS_SET = CALS_SET;
	var CALS_FAILURE = "cals_failure";
	
	exports.CALS_FAILURE = CALS_FAILURE;
	// Action creators
	...
	function loginToParticle(email, password) {
	  return function (dispatch) {
	    dispatch(loginRequest());
	    _libSpark2["default"].login({
	      username: email,
	      password: password
	    }, function (err, data) {
	      if (err) {
	        ...
	        _PersistentState2["default"].saveToken(data.access_token);
	...
	var deviceName = "silvia";
	var deviceEvent = "coffee";
	var deviceCals = "cals";
	var deviceWakeupTime = "Twakeup";
	...
	function subscribeToDeviceData() {
	  return function (dispatch) {
	    var request = _libSpark2["default"].getEventStream(deviceEvent, deviceName, function (event) {
	      if (event instanceof Error) {
	        console.log(event);
	      } else {
	        var rawData = JSON.parse(event.data);
	        var data = _libFirmwareDataMapper2["default"].variablesToApp(rawData);
	...
	function fetchCalibrations() {
	  return function (dispatch) {
	    ...
	    _libSpark2["default"].getVariable(deviceName, deviceCals).then(function (payload) {
	      var rawData = JSON.parse(payload.result);
	      var data = _libFirmwareDataMapper2["default"].calibrationsToApp(rawData);
	...
	function fetchWakeupTime() {
	  return function (dispatch) {
	    var group = "sleepCals";
	
	    dispatch(calsFetch(group));
	
	    _libSpark2["default"].callFunction(deviceName, "get", deviceWakeupTime).then(function () {
	      return _libSpark2["default"].getVariable(deviceName, "result");
	    }).then(function (payload) {
	      var wakeupTime = JSON.parse(payload.result);
	
	      dispatch(calsReceive(group));
	      dispatch(calsSet({ wakeupTime: wakeupTime }));
	    })["catch"](function (err) {
	      dispatch(calsFailure(group));
	      console.log(err);
	    });
	...
	function setCalibration(cal, value) {
	  return function (dispatch) {
	    var firmwareCal = _libFirmwareDataMapper2["default"].calibrationFirmwareName(cal);
	    var firmwareValue = _libFirmwareDataMapper2["default"].calibrationFirmwareValue(cal, value);
	
	    _libSpark2["default"].callFunction(deviceName, "set", firmwareCal + "=" + firmwareValue).then(function () {
	      dispatch(calsSet(_defineProperty({}, cal, value)));
	    })["catch"](function (err) {
	      console.log(err);
	    });
	  };
...
/***/ function(module, exports) {
	...
	exports["default"] = {
	  variablesToApp: function variablesToApp(data) {
	    return {
	  ...
	  calibrationsToApp: function calibrationsToApp(data) {
	    return {
	  ...
	  calibrationFirmwareName: function calibrationFirmwareName(name) {
	    return ({
	  ...
	  calibrationFirmwareValue: function calibrationFirmwareValue(name, value) {
	    if (name === "sleeping") {
	      return value ? 1 : 0;
	    }
	    return value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersLoginJsx = __webpack_require__(185);
	
	var _containersLoginJsx2 = _interopRequireDefault(_containersLoginJsx);
	
	var _containersMainJsx = __webpack_require__(193);
	
	var _containersMainJsx2 = _interopRequireDefault(_containersMainJsx);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function applyToken() {
	      if (this.props.token) {
	        this.props.dispatch((0, _actions.loginWithToken)(this.props.token));
	      }
	    }
	  }, {
	    key: "renderPage",
	    value: function renderPage() {
	      if (this.props.token) {
	        return _react2["default"].createElement(_containersMainJsx2["default"], null);
	      }
	      return _react2["default"].createElement(_containersLoginJsx2["default"], null);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsLoginFormJsx = __webpack_require__(186);
	...
	var Login = (function (_Component) {
	  ...
	  _createClass(Login, [{
	    ...
	    value: function handleLogin(email, password) {
	      this.props.dispatch((0, _actions.loginToParticle)(email, password));
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      return _react2["default"].createElement(_componentsLoginFormJsx2["default"], { handleLogin: this.handleLogin.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PureComponent2 = __webpack_require__(187);
	...
	var LoginForm = (function (_PureComponent) {
	  ...
	  _createClass(LoginForm, [{
	    ...
	    value: function render() {
	      ...
	      var busyIcon = _react2["default"].createElement("i", { className: "glyphicon glyphicon-hourglass" });
	      var failureMessage = this.props.failed ? _react2["default"].createElement(
	        "div",
	        { className: "error" },
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "form",
	            { className: "login-form", onSubmit: this.handleLogin.bind(this) },
	            _react2["default"].createElement("input", _extends({ type: "email", name: "email", value: this.state.email,
	              placeholder: "Particle.io email" }, fieldProps)),
	            _react2["default"].createElement("input", _extends({ type: "password", name: "password", value: this.state.password,
	...
	LoginForm.propTypes = {
	  inProgress: _react.PropTypes.bool.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libNextTimestamp = __webpack_require__(194);
	
	var _libNextTimestamp2 = _interopRequireDefault(_libNextTimestamp);
	
	var _containersHeaderJsx = __webpack_require__(195);
	
	var _containersHeaderJsx2 = _interopRequireDefault(_containersHeaderJsx);
	
	var _componentsFooterJsx = __webpack_require__(199);
	
	var _componentsFooterJsx2 = _interopRequireDefault(_componentsFooterJsx);
	
	var _componentsStatusJsx = __webpack_require__(200);
	
	var _componentsStatusJsx2 = _interopRequireDefault(_componentsStatusJsx);
	
	var _componentsCalibrateJsx = __webpack_require__(202);
	
	var _componentsCalibrateJsx2 = _interopRequireDefault(_componentsCalibrateJsx);
	
	var _componentsSleepJsx = __webpack_require__(204);
	
	var _componentsSleepJsx2 = _interopRequireDefault(_componentsSleepJsx);
	...
	var Main = (function (_Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "div",
	          { className: "wrap" },
	          _react2["default"].createElement(_containersHeaderJsx2["default"], null),
	          _react2["default"].createElement(_componentsStatusJsx2["default"], this.data()),
	          page(),
	          _react2["default"].createElement(_componentsFooterJsx2["default"], null)
	        )
	      );
	    }
	  }, {
	    ...
	    value: function componentDidMount() {
	      this.props.dispatch((0, _actions.subscribeToDeviceData)());
	    }
	  }, {
	    key: "loadMainCals",
	    value: function loadMainCals() {
	      if (this.props.calibrations.state.mainCals === "not loaded") {
	        this.props.dispatch((0, _actions.fetchCalibrations)());
	      }
	    }
	  }, {
	    key: "loadSleepCals",
	    value: function loadSleepCals() {
	      if (this.props.calibrations.state.sleepCals === "not loaded") {
	        this.props.dispatch((0, _actions.fetchWakeupTime)());
	      }
	    }
	  }, {
	    key: "handleCalChange",
	    value: function handleCalChange(field, value) {
	      switch (field) {
	        case "sleeping":
	          var wakeupTime = this.props.calibrations.data.wakeupTime;
	
	          if (wakeupTime) {
	            wakeupTime = (0, _libNextTimestamp2["default"])(wakeupTime);
	
	            this.props.dispatch((0, _actions.setCalibration)("wakeupTime", wakeupTime));
	          }
	          this.props.dispatch((0, _actions.setCalibration)(field, value));
	          break;
	        case "wakeupTime":
	...
	Main.renderPage.calibrate = function () {
	  var data = this.props.calibrations.data;
	  var calProps = {
	  ...
	  return _react2["default"].createElement(_componentsCalibrateJsx2["default"], _extends({}, this.data(), calProps, {
	...
	Main.renderPage.sleep = function () {
	  ...
	  return _react2["default"].createElement(_componentsSleepJsx2["default"], _extends({}, sleepProps, {
	...
	Main.propTypes = {
	  ...
	  calibrations: _react.PropTypes.object.isRequired
	};
...
/***/ function(module, exports) {
	...
	exports["default"] = function (timestamp) {
	  ...
	  var S_IN_DAY = 24 * 60 * 60;
	  var timestampNow = now.valueOf() / 1000;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsNavbarJsx = __webpack_require__(196);
	...
	var Header = (function (_Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function handleNavigate(event) {
	      this.props.dispatch((0, _actions.navigateTo)(event.target.page));
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      return _react2["default"].createElement(_componentsNavbarJsx2["default"], { page: this.props.page, handleNavigate: this.handleNavigate.bind(this) });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavPillJsx = __webpack_require__(197);
	
	var _NavPillJsx2 = _interopRequireDefault(_NavPillJsx);
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(_NavPillJsx2["default"], _extends({ name: "Status", page: "status" }, pillProps)),
	          _react2["default"].createElement(_NavPillJsx2["default"], _extends({ name: "Calibrate", page: "calibrate" }, pillProps)),
	          _react2["default"].createElement(_NavPillJsx2["default"], _extends({ name: "Sleep", page: "sleep" }, pillProps))
	        ),
	        _react2["default"].createElement(
	          "h3",
	          { className: "text-muted" },
	...
	Navbar.propTypes = {
	  handleNavigate: _react.PropTypes.func.isRequired,
	  page: _react.PropTypes.string.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavPill = (function (_PureComponent) {
	  _inherits(NavPill, _PureComponent);
	
	  function NavPill() {
	    _classCallCheck(this, NavPill);
	
	    _get(Object.getPrototypeOf(NavPill.prototype), "constructor", this).apply(this, arguments);
	  }
	
	  _createClass(NavPill, [{
	    key: "handleClick",
	...
	NavPill.propTypes = {
	  ...
	  page: _react.PropTypes.string.isRequired,
	  activePage: _react.PropTypes.string.isRequired,
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "p",
	          null,
	          "sleep icon by Matt Brooks from the Noun Project"
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libRound = __webpack_require__(201);
	...
	var Status = (function (_PureComponent) {
	  ...
	  _createClass(Status, [{
	    ...
	    value: function renderTemperature() {
	      if (this.props.sleeping) {
	        return _react2["default"].createElement("i", { className: "silvia silvia-sleep" });
	      }
	
	      return (0, _libRound.roundPrec)(this.props.temperature, 0);
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "div",
	            { className: "circle circle-medium circle-border" },
	            _react2["default"].createElement(
	              "div",
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              "div",
	              { className: "col-sm-3 col-md-3 col-md-offset-2" },
	              _react2["default"].createElement(
	                "h2",
	                null,
	                "Heater ",
	            ...
	            _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                "div",
	                { className: "progress progress-side" },
	                _react2["default"].createElement("div", { className: "progress-bar progress-bar-warning", style: { width: powerLog + "%" } })
	              )
	            )
	          )
	        )
	...
	Status.propTypes = {
	  sleeping: _react.PropTypes.bool,
	  temperature: _react.PropTypes.number,
	  power: _react.PropTypes.number
	};
...
/***/ function(module, exports) {
	...
	exports["default"] = {
	  roundPrec: function roundPrec(value, precision) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CalValueJsx = __webpack_require__(203);
	
	var _CalValueJsx2 = _interopRequireDefault(_CalValueJsx);
	
	var _libRound = __webpack_require__(201);
	
	var Calibrate = (function (_PureComponent) {
	  _inherits(Calibrate, _PureComponent);
	
	  function Calibrate(props) {
	    _classCallCheck(this, Calibrate);
	
	    _get(Object.getPrototypeOf(Calibrate.prototype), "constructor", this).call(this, props);
	    this.onChange = this.onChange.bind(this);
	    this.changeHandlers = {};
	  }
	
	  _createClass(Calibrate, [{
	    key: "onChange",
	    ...
	    value: function render() {
	      ...
	      var iPartOld = loaded ? this.props.iPart - this.props.integral * this.props.error : "–";
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "table",
	            { className: "calibration-table table table-striped" },
	            _react2["default"].createElement(
	              "thead",
	              null,
	              _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  (0, _libRound.roundPrec)(this.props.error, 1)
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  _react2["default"].createElement(_CalValueJsx2["default"], { value: (0, _libRound.roundPrec)(this.props.targetTemperature, 1), disabled: !loaded,
	                    onChange: this.onChange("targetTemperature") })
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  (0, _libRound.roundPrec)(this.props.temperature, 1)
	                )
	              )
	            )
	          ),
	            ...
	            _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  (0, _libRound.roundPrec)(this.props.power, 1)
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  _react2["default"].createElement(_CalValueJsx2["default"], { value: (0, _libRound.roundPrec)(this.props.offset, 1), disabled: !loaded,
	                    onChange: this.onChange("offset") })
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  _react2["default"].createElement(_CalValueJsx2["default"], { value: (0, _libRound.roundPrec)(this.props.proportional, 1), disabled: !loaded,
	                    onChange: this.onChange("proportional") })
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  (0, _libRound.roundPrec)(this.props.iPart, 1)
	                )
	              )
	            )
	          ),
	            ...
	            _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  (0, _libRound.roundPrec)(iPartOld, 1)
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                ...
	                _react2["default"].createElement(
	                  "td",
	                  null,
	                  _react2["default"].createElement(_CalValueJsx2["default"], { value: (0, _libRound.roundPrec)(this.props.integral, 3), disabled: !loaded,
	                    onChange: this.onChange("integral") })
	                ),
	                _react2["default"].createElement(
	                  "td",
	                  null,
	...
	Calibrate.propTypes = {
	  ...
	  error: _react.PropTypes.number,
	  power: _react.PropTypes.number,
	  temperature: _react.PropTypes.number,
	  targetTemperature: _react.PropTypes.number,
	  offset: _react.PropTypes.number,
	  proportional: _react.PropTypes.number,
	  integral: _react.PropTypes.number,
	  iPart: _react.PropTypes.number
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalValue = (function (_Component) {
	  _inherits(CalValue, _Component);
	
	  function CalValue(props) {
	    _classCallCheck(this, CalValue);
	
	    _get(Object.getPrototypeOf(CalValue.prototype), "constructor", this).call(this, props);
	    this.emitChange = this.emitChange.bind(this);
	    this.keyDown = this.keyDown.bind(this);
	  }
	
	  _createClass(CalValue, [{
	    key: "render",
	    value: function render() {
	    ...
	    value: function componentDidUpdate() {
	      if (this.props.value !== _react2["default"].findDOMNode(this).innerHTML) {
	        _react2["default"].findDOMNode(this).innerHTML = this.props.value;
	      }
	    }
	  }, {
	    key: "keyDown",
	    ...
	    key: "emitChange",
	    value: function emitChange(event) {
	      var value = _react2["default"].findDOMNode(this).innerHTML;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sleep = (function (_PureComponent) {
	  _inherits(Sleep, _PureComponent);
	
	  function Sleep(props) {
	    _classCallCheck(this, Sleep);
	
	    _get(Object.getPrototypeOf(Sleep.prototype), "constructor", this).call(this, props);
	  ...
	  _createClass(Sleep, [{
	    key: "onSleep",
	    value: function onSleep() {
	      this.props.handleChange("sleeping", true);
	    }
	  }, {
	    key: "onWake",
	    value: function onWake() {
	    ...
	    value: function handleTime(event) {
	      var MS_PER_S = 1000;
	      var now = new Date();
	      var timestamp = Date.parse(now.getFullYear() + "-" + (now.getMonth() + 1) + "-" + now.getDate() + " " + event.target.value) / MS_PER_S;
	
	      timestamp = (0, _libNextTimestamp2["default"])(timestamp, now);
	
	      this.props.handleChange("wakeupTime", timestamp);
	    }
	  }, {
	    key: "timeFromTimestamp",
	    value: function timeFromTimestamp(timestamp) {
	    ...
	    value: function render() {
	      var loaded = this.props.loaded;
	      var wakeupTime = loaded ? this.timeFromTimestamp(this.props.wakeupTime) : "–";
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              "button",
	              { className: "btn btn-warning btn-lg", disabled: !loaded,
	                onClick: this.onSleep },
	              "Sleep"
	            ),
	            " until ",
	            _react2["default"].createElement(
	              "td",
	              null,
	              _react2["default"].createElement(_CalValueJsx2["default"], { value: wakeupTime, disabled: !loaded,
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              "button",
	              { className: "btn btn-success btn-lg", disabled: !loaded,
	                onClick: this.onWake },
	              "Wake up!"
	            )
	          )
	...
	Sleep.propTypes = {
	  ...
	  handleChange: _react.PropTypes.func.isRequired,
	  loaded: _react.PropTypes.bool.isRequired,
	  wakeupTime: _react.PropTypes.number
	};
